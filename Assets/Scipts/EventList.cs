...
public class EventList : MonoBehaviour
{
    ...
    [SerializeField] public Button favoriteList;
    ...
    public void FavoriteListClick()
    {
        SceneManager.LoadScene("FavoritesList");

        Debug.Log("Clicked GetFavorites!");
    }
    ...
    public IEnumerator GetEvents()
    {
        ...
        else
        {
            ...
            for (int i = 0; i < eventCount; i++)
            {
                ...
                newEvent.transform.Find("EventId").GetComponent<TextMeshProUGUI>().text = eventData._id;
                ...
                newEvent.transform.Find("EventDate").GetComponent<TextMeshProUGUI>().text = eventData.eventDate;
                newEvent.transform.Find("EventTime").GetComponent<TextMeshProUGUI>().text = eventData.eventTime;

                Button favoriteEvent = newEvent.transform.Find("FavoriteEvent").GetComponent<Button>();
                favoriteEvent.onClick.AddListener(() => FavoriteEventClick(eventData._id));
    ...
    private IEnumerator GetEventDetails(string eventId)
    {
        ...
        else
        {
            ...
            favoriteEvent.transform.Find("EventID").GetComponent<TextMeshProUGUI>().text = eventData._id;
